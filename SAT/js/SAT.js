/* eslint complexity: "off", valid-jsdoc: "off"*/
/**
...
function SATTest(polygonA, polygonB) {
  ...
  */
  function getAxes(polygon) {
    ...
    vertices.forEach(function(vertexA, index) {
      var vertexB = vertices[index + 1 === vertices.length ? 0 : index + 1];
  ...
  */
  function getProjection(polygon, axis) {
    ...
    vertices.forEach(function(vertex) {
      dot = vectorMath.dot(axis, vertex);
    ...
    for (i = 0; i < axes.length; i++) {
      ...
      // Note: dyn4j mentions that whichever is smaller, be prepared to negate/flip the axis
        ...
        if (typeof mtvInfo.magnitude === 'undefined' || overlap < mtvInfo.magnitude) {
          mtvInfo = {
            magnitude: overlap,
            axis: i >= axesA.length ? axis : vectorMath.negate(axis),
            origin: polygonA
          };
        }
      }
